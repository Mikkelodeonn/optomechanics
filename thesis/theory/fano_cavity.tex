...
%% add the part where the simulated linewidths as a function of losses is compared with the analytical formula, when the analytical formula is added to the figure.
