...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{figures/detuning_scan_double_fano_30um_intracavity_normalized.pdf}
        \caption{}
        \label{fig:detuning_scan_intracavity_normalized}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{figures/detuning_scan_double_fano_30um_intracavity_max_values.pdf}
        \caption{}
        \label{fig:detuning_scan_intracavity_max_values}
    \end{subfigure}
