...
data = np.loadtxt("/Users/mikkelodeon/optomechanics/Double fano cavity/M3+M5/data/20250314/75um/fsr.txt")#[3:-11]
PI = np.loadtxt("/Users/mikkelodeon/optomechanics/Double fano cavity/M3+M5/data/20250314/75um/fsr_PI.txt")#[3:-11]
...
p0 = [np.sqrt(0.3), np.sqrt(0.7), 75e3, np.pi/2]
