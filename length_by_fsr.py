...
data = np.loadtxt("/Users/mikkelodeon/optomechanics/Double fano cavity/M3+M5/data/20250226/25um/fsr.txt")#[3:-11]
PI = np.loadtxt("/Users/mikkelodeon/optomechanics/Double fano cavity/M3+M5/data/20250226/25um/fsr_PI.txt")#[3:-11]
...
p0 = [np.sqrt(0.85), np.sqrt(0.1), 30e3, np.pi/2]
