...
data = np.loadtxt("/Users/mikkelodeon/optomechanics/Double fano cavity/M3+M5/data/20250207/59um/59fsr.txt")[3:-1]
PI = np.loadtxt("/Users/mikkelodeon/optomechanics/Double fano cavity/M3+M5/data/20250207/59um/59fsr_PI.txt")[3:-1]
...
p0 = [np.sqrt(0.85), np.sqrt(0.1), 50e3, np.pi/2]
