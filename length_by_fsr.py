...
data = np.loadtxt("/Users/mikkelodeon/optomechanics/Double fano cavity/M3+M5/data/20250225/20um/20fsr.txt")[3:-11]
PI = np.loadtxt("/Users/mikkelodeon/optomechanics/Double fano cavity/M3+M5/data/20250225/20um/20fsr_PI.txt")[3:-11]
...
p0 = [np.sqrt(0.85), np.sqrt(0.1), 18e3, np.pi/2]
